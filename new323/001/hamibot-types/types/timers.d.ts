 ...
 * @LastEditor: BATU1579
 * @LastTime: 2022-10-28 15:57:35
 * @FilePath: \\types\\timers.d.ts
 * @Description: 定时器模块
 */
declare module 'timers' {
    global {
         ...
         */
        function setInterval(callback: Callback, delay: number, ...args: any[]): IntervalID;
         ...
         */
        function setTimeout(callback: Callback, delay: number, ...args: any[]): TimeoutID;
         ...
         */
        function setImmediate(callback: Callback, ...args: any[]): ImmediateID;
